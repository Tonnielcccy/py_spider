...
class AnjukeSpider(scrapy.Spider):
    ...
    custom_settings = {
        'DOWNLOADER_MIDDLEWARES': {
            'anjuke_scrapy.middlewares.wh_middleware.WuhanMiddleware': 400,
            'anjuke_scrapy.middlewares.wh_middleware.RandomUserAgentMiddleware': 401,
            'anjuke_scrapy.middlewares.wh_middleware.CustomHeadersMiddleware': 402,
            'anjuke_scrapy.middlewares.wh_middleware.CustomCookiesMiddleware': 403,
        }
    }
    allowed_domains = ["anjuke.com"]  # 限制爬虫范围
    start_urls = ["https://wh.zu.anjuke.com/?from=HomePage_TopBar"] # 起始网址
